...
# Verificar que se hayan proporcionado al menos dos parámetros
if [ "$#" -lt 2 ]; then
    echo "Error: Debes proporcionar dos parámetros:"
    echo "  1. La ruta completa del directorio a crear, incluyendo su nombre."
    echo "  2. La ruta de un archivo existente a copiar dentro del directorio."
    exit 1
fi
